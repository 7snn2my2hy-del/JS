...
function saveUrlaub() {
  ...
  // Faelligkeit des Restbetrags (optional) - leer bedeutet Reisemonat
  const dueMRaw = parseInt(($('urlaub-due-m') || {}).value, 10);
  const dueYRaw = parseInt(($('urlaub-due-y') || {}).value, 10);
