...
function renderUrlaubKontingentRows() {
  ...
  wrap.innerHTML = numYears.map((y, i) => {
    ...
    if (i === 0) return `<div class="uc-budget-row"><span class="ub-label">Urlaubskontingent</span>${wert}</div>`;
